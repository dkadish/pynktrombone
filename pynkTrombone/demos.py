...
def tongue_diameter():
    ...
    play_update(td, 'tongue_diameter_0-3.5.wav')
...
def throat_open_shut():
    ...
    play_update(t, 'trachea_0-3.5.wav')
...
def frequency():
    ...
    sf.write('frequency_60-180.wav', out, sr)
...
def tenseness():
    ...
    play_update(t, 'tenseness_0-1.wav')
...
def epiglottis():
    ...
    play_update(t, 'epiglottis_0-3.5.wav')
